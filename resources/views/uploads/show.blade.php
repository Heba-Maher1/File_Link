<x-main-layout title="Show">
    <div class="mt-5 shadow-lg" style="width: 400px; background: white; padding: 30px; border-radius: 10px;">
            <div class="text-center">
                ...
                <div id="textToCopy" class="text-secondary py-3 px-3 border mb-4" style="display: none">{{ $link }}</div>
                <a id="copyBtn" onclick="copyText()" class="btn btn-lg btn-block w-100 text-white mb-2" style="background: #456991"><i class="fa-solid fa-copy"></i></a>
